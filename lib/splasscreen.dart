    ...
    return Scaffold(
      ...
      body: Column(
        ...
        children: <Widget>[
          ...
          SizedBox(height: 20,),
          Text('Nouman Razaq', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 30.0, color: Colors.white),),
          SizedBox(height: 30,),
          Text("Registration No : SP17-BCS-045",style: TextStyle(fontWeight: FontWeight.bold, fontSize: 20.0, color: Colors.white),),
